		...
		protected String doInBackground(String... urls) {
			try{
				...
				if(newsDetails!=null && !newsDetails.getText().toString().equalsIgnoreCase("") && newsTitle!=null && !newsTitle.getText().toString().equalsIgnoreCase("")){
					...
					String newsTitleStr = new String(newsTitle.getText().toString().getBytes("UTF-8"), "UTF-8");
					String newsDetailsStr = new String(newsDetails.getText().toString().getBytes("UTF-8"), "UTF-8");
