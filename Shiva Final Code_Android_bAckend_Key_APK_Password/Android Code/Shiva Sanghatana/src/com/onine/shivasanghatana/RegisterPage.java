		...
		protected String doInBackground(String... urls) {
			try{
				...
				if(     name!=null && !name.getText().toString().equalsIgnoreCase("")
					...
					String nameStr = new String(name.getText().toString().getBytes("UTF-8"), "UTF-8");
					String phonenumberStr = new String(phonenumber.getText().toString().getBytes("UTF-8"), "UTF-8");
					String cityStr = new String(city.getText().toString().getBytes("UTF-8"), "UTF-8");
					String countryStr = new String(country.getText().toString().getBytes("UTF-8"), "UTF-8");
					String genderStr = new String(gender.getText().toString().getBytes("UTF-8"), "UTF-8");
					String passwordStr = new String(password.getText().toString().getBytes("UTF-8"), "UTF-8");
					String positionStr = new String(position.getText().toString().getBytes("UTF-8"), "UTF-8");
