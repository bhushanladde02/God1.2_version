...
CREATE TABLE `registeruser` (
  ...
  `matrialstatus` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `age` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `country` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `department` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `deviceid` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `lastupdatedate` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `verify` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `registeruser` VALUES (2,'bhushan arun ladde','','',8793501156,'','nasik','','male','','','india','','bb89c7e8dd5d6bf4','2015/05/12','1234','76772','N'),(11,'    Ladde Arun Kashinath','','',8149639981,'','    Nashik','','   Male','','','    India','','5ea8c2557aa012c9','2015/05/17','Arun','11009','N'),(12,'Rahul Wani','','',7030466735,'','Nashik','','Male','','','India','','9f12f40561deb18','2015/05/17','rahulwani','29877','N'),(13,'Shrikant Avinashappa Shete','','',9527128286,'','Lonar','','Male','','','India','','22076b3fb442c0dd','2015/05/17','pallu','29143','N'),(15,'manish sudhakar appa pandhade','','',9225722655,'','buldhana ','','male ','','','india ','','4e968e3eba63197b','2015/05/18','93710105','90200','N'),(16,'Rameshwar p gabale','','',9372491464,'','Aurangabad','','wani','','','india','','d2b261201ab6dd25','2015/05/18','ramgabale','93132','N'),(17,'pandurang madhav kamjalge','','',9763660609,'','nanded','','male','','','india','','338fe2305daa656b','2015/05/18','8007823234','16764','N'),(18,'SHILENDRAKUMAR GURURAJ SW\n\n\n\n   \n\n\n\n\n\n\n SHILENDRAKUMAR GURURAJ SWAMI\n\nAMI','','',8856036653,'','LATUR','','MAIL2','','','INDIA','','bdae201fa0c6afb7','2015/05/19','24682468','31187','N'),(19,'kamalakar tambade','','',9689716961,'','jewali(d)','','mail','','','Bharat','','97fe875937251c48','2015/05/19','83208320','36314','N');
...
-- Dump completed on 2015-05-19 16:11:02
